                        ...
                        <div class="j_document" >
                            ...
                            <div class="docu_info">
                                ...
                                <div class="docu_detail">
                                    <h4>預約老師：{{docuDetail[0].name}}</h4>
                                    <h4>預約日期：{{docuDetail[0].date}}</h4>
                                    <h4>預約時段：晚上07:00</h4>  
                                </div>
                                <div class="docu_money">
                                    <h4 >金額: {{docuDetail[0].money}}</h4>
                                </div>
                            

                            </div>
                            <div class="docu_total">
                                <h4 id="money">結帳金額: {{docuDetail[0].money}}</h4>
                            </div>
                            ...
                            <form >
                                ...
                                <div class="form_info">
                                    <div class="form_left">
                                        <div class="name" >
                                            <h4>A. 姓名</h4>
                                            <input type="text" placeholder="請輸入文字"  required="" v-model="name">
                                        </div>
                                        <div class="bd">
                                            <h4>B. 生日</h4>
                                        ...
                                        <div class="tel">
                                            <h4>C. 聯絡電話</h4>
                                            <input type="tel" name="" placeholder="請輸入電話">
                                        </div>
                                        <div class="email">
                                            <h4>E. 聯絡信箱</h4>
                                            <input type="email" name="" placeholder="請輸入信箱">
                                        </div>
                                        <div class="comment">
                                            <h4>F. 預約備註</h4>
                                        ...
                                        <label for="ammount">付款方式</label><br>
                                            <select name="payment" id="payment">
                                                <option value="credit card">信用卡付款(經由綠世界)</option>  
                                            </select>
                                    ...
                                    <div class="form_right">
                                        <button class="j_right">
                                            <a href="/apfinish" class="j_right">結帳</a>
...
export default {
    ...
    data() {
        return {
            ...
            docuDetail:[
                {name:'唐揚雞老師', money:'2,000', date:'2021/05/23'},
                {name:'卡拉雞老師', money:'2,500', date:'2021/05/26'},
                {name:'危雞老師', money:'1,500', date:'2021/05/24'},
