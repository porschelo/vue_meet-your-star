...
export default {
    data() {
        return {
            ...
            teacherpic: [
                {
                    img: '/images/appointment/dr1.png',
                    name: '安格斯雞老師',
                    special: '開啟財運大門',
                    money: '1,000',
                },
                {
                    img: '/images/appointment/dr2.png',
                    name: '危機老師',
                    special: '工作危機處理',
                    money: '1,500',
                },
                {
                    img: '/images/appointment/dr3.png',
                    name: '唐揚雞老師',
                    special: '愛情魔幻靈藥',
                    money: '2,000',
                },
    ...
    methods: {
        onChangeName() {
            // this.$store.commit('increment', 'Tommy');
            // this.$store.dispatch('setName', 'Tommy');
            this.$store.dispatch('addCart', {
                name: '商品一',
                price: 200,
                qty: 2,
            });
            // this.$store.commit('addCart1', {
            //     name: '商品一',
            //     price: 200,
            //     qty: 2,
            // });
