<template>
    <div id="app">
        <my-header v-if="$route.name !== 'Landing' && $route.name!=='BackMember' && $route.name!=='BackShoppingProduct' && $route.name!=='BackProductCreate'&& $route.name!=='BackStarDaily'"></my-header>
